export const ReportesEndPoint = {
    DESCARGAR_REPORTE_POR_USUARIOS: 'ReporteInventarioUnnoCycle/descargar-reportes-por-usuario',
    DESCARGAR_REPORTE_DIARIOS: 'ReporteInventarioUnnoCycle/descargar-reporte-diario-completo',
